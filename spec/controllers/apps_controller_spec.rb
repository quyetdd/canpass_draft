  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved app as @app" do
        ...
        post :create, {:app => { "config" => "invalid value" }}, valid_session
        assigns(:app).should be_a_new(App)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested app" do
        ...
        App.any_instance.should_receive(:update_attributes).with({ "config" => "MyString" })
        put :update, {:id => app.to_param, :app => { "config" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the app as @app" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        App.any_instance.stub(:save).and_return(false)
        put :update, {:id => app.to_param, :app => { "config" => "invalid value" }}, valid_session
        assigns(:app).should eq(app)
      end
